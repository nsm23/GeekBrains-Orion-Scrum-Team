...
class Post(models.Model):
    ...
    user_id = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, on_delete=models.SET_NULL, related_name='posts', verbose_name="Автор")
    hub_id = models.ForeignKey(Hub, null=True, blank=True, on_delete=models.SET_NULL, related_name='posts', verbose_name="Хаб")
